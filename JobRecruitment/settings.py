...
ALLOWED_HOSTS = ["*"]   
# MODEL_CHECKPOINT_PATH = os.path.join("/Users/w.jerry/ICE3608-01-violence_checker/violence_check/train_logs/resnet50_pretrain_test/version_6/checkpoints/resnet50_pretrain_test-epoch=16-val_loss=0.06.ckpt")
VIOLENCE_MODEL_CHECKPOINT = os.path.join(
...
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')  # 确保路径正确
